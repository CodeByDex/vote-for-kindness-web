...
export default function Home() {
  return (
    <>
      <Head>
        <title>Chris Caldwell — Vote for Kindness</title>
        <meta name="description" content="Chris Caldwell for Mayor of Findlay, Ohio — Vote for kindness, community, the neighborly candidate." />
      </Head>

      <div className="min-h-screen bg-brand antialiased">
